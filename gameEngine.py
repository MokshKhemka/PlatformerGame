...
class GameEngineClass:
    ...
    def __init__(self):
        ...
        from platform_objects import PlatformManagerClass, EnemyManagerClass
    ...
    def update_game_state(self):
        ...
        for enemy in self.enemyperson.get_all_enemies():
            if self.collisionHandles.check_collision(self.player, enemy):
    ...
    def render_game_screen(self):
        ...
        for enemy in self.enemyperson.get_all_enemies():
            pygame.draw.rect(self.screen_surface, enemy.color_value,
                             (enemy.x_position - self.camera_x_offset, enemy.y_position,
                              enemy.width_value, enemy.height_value))
        
        pygame.draw.rect(self.screen_surface, self.player.color_value,
                        (self.player.x_position - self.camera_x_offset,
